...
3️⃣ ShiftRows: Concatenate the bytes of the input corresponding to the bytes of the output to be rotated.
...
- Rcons: Design each one separately and package it because we only need 10 Rcons.
